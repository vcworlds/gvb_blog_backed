...
type UserModel struct {
	...
	Salt          string           `json:"salt" gorm:"default:PasswordSalt"` // 密码盐
	Avatar        Avatar           `gorm:"size:26" json:"-"`                 // 头像
	...
	Role          ctype.Role       `gorm:"size:4;default:3" json:"role"`                                                                        // 角色 1 管理员 2 普通用户 3 游客 4 被禁用
